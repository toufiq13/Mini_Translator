...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 overflow-hidden bg-[#020617]">
      {/* Left Content Section */}
      <div className="relative hidden lg:flex flex-col justify-between p-12 text-white overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <div className="size-8 rounded-lg bg-indigo-500/20 backdrop-blur-md border border-white/10 flex items-center justify-center">
              <Sparkles className="size-4 text-indigo-400" />
            </div>
            <span className="tracking-tight">MiniTranslator</span>
          </div>
        </div>
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            <div 
              ref={purpleRef}
              className="absolute bottom-0 transition-all duration-700 ease-in-out shadow-2xl shadow-purple-500/30"
              style={{
                left: '70px',
                width: '180px',
      ...
      {/* Right Login Section */}
      <div className="flex items-center justify-center p-8 bg-[#020617] h-full text-white">
        <div className="w-full max-w-[420px] bg-white/5 p-8 rounded-3xl backdrop-blur-2xl border border-white/10 shadow-2xl relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pl-10 bg-white/5 border-white/10 text-white placeholder:text-white/20 focus:ring-indigo-500/50"
                />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-white/5 border-white/10 text-white placeholder:text-white/20 focus:ring-indigo-500/50"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" title="Recover Password" className="text-sm text-indigo-400 hover:text-indigo-300 hover:underline font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center text-sm text-white/40 mt-8">
            ...
            <Link to="/signup" className="text-indigo-400 font-medium hover:text-indigo-300 hover:underline">
              Sign Up
            </Link>
          </div>
        </div>
